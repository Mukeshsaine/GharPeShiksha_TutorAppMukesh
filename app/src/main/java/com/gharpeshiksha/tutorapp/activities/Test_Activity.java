...
import com.gharpeshiksha.tutorapp.databinding.ActivityTestBinding;
...
public class Test_Activity extends AppCompatActivity {
    ...
    List<NotesModel> TestModelList = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TestModelList.add(new NotesModel(url1,"Physics"));
        TestModelList.add(new NotesModel(url2,"Physics"));
        TestModelList.add(new NotesModel(url3,"Physics"));
        TestModelList.add(new NotesModel(url4,"Physics"));
        TestModelList.add(new NotesModel(url5,"Physics"));
        Adapter_Notes adapter_notes = new Adapter_Notes(getApplicationContext(),TestModelList);
